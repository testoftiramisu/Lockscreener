...
public class WinRegistry {
    ...
    private static int deleteValue(Preferences root, int hkey, String key, String value)
        ...
        int rc = (Integer) regDeleteValue.invoke(root, handles[0],
                toCstr(value));
    ...
    private static int deleteKey(Preferences root, int hkey, String key)
            throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
        int rc = (Integer) regDeleteKey.invoke(root, hkey, toCstr(key));
    ...
    private static List<String> readStringSubKeys(Preferences root, int hkey, String key)
        ...
        int[] handles = (int[]) regOpenKey.invoke(root, hkey,
                toCstr(key),
                KEY_READ);
        if (handles[1] != REG_SUCCESS) {
            return null;
    ...
    private static void writeStringValue(Preferences root, int hkey, String key, String valueName, String value)
        ...
        int result = (Integer) regSetValueEx.invoke(root, handles[0], toCstr(valueName), toCstr(value));
